...
<body>
    ...
    <div class="wrapper">
        ...
        <script src="./cashflow/flow/js/jquery-3.3.1.min.js"></script>
        <!-- <script src="popper/popper.js"></script> -->
        <!-- <script src="bootstrap/js/bootstrap.min.js"></script> -->
        <script type="text/javascript" src="./cashflow/flow/js/datatables.min.js"></script>
        <script type="text/javascript" src="./cashflow/flow/js/dataTables.searchPanes.min.js"></script>
        <script type="text/javascript" src="./cashflow/flow/js/dataTables.select.min.js"></script>
